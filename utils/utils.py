...
def display_bbox(bboxes, fig, ax, classes=None, in_format='xyxy', color='y', line_width=3,temp=1):
    ...
    for box in bboxes:
        ...
        # display category
        if classes:
            # In changing here: CHANGE:MODIFY
            if classes[c] == 'pad' or classes[c] == 'background':
                continue
            if(temp==1):
