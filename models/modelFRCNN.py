...
from vig_with_skip import vig_ti_224_gelu
...
class RegionProposalNetwork(nn.Module):
    ...
    def forward(self, images, gt_bboxes, gt_classes):
        ...
        # this is where the output from ViG arrives
...
class ClassificationModule(nn.Module):
    def __init__(self, out_channels, roi_size,n_classes=2, hidden_dim=512, p_dropout=0.3):
        super().__init__()        
...
class TwoStageDetector(nn.Module):
    def __init__(self, img_size, out_size, out_channels, n_classes, roi_size):
        ...
        self.classifier = ClassificationModule(out_channels, roi_size, n_classes)
